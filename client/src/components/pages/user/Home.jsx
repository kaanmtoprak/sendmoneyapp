...
const Home = () => {
  ...
  // const [starterOne,setStarterOne] =useState(1)
  // const [starterTwo,setStarterTwo] =useState(18)
...
//   const filterredRadio = activeCurrencies.filter(filtered => filtered ==="KES")
//     console.log(filterredRadio);
//  }else console.log("olmadı")
